<template>
	<div id="main">
        ...
        <div class="search-barre">
            ...
            <input placeholder="Saisissez l'adresse..." class="input-search" type="text" ref="searchInput">
        </div>
            ...
            useCurrentLocation() {
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(async (position) => {
                        ...
                        this.$refs.searchInput.value = address; // Met à jour le champ de recherche
                    }, () => {
